...
CREATE TABLE public.affiliates (
  ...
  affiliate_code TEXT NOT NULL DEFAULT generate_affiliate_code() UNIQUE,
...
CREATE TABLE public.affiliate_links (
  ...
  tracking_code TEXT NOT NULL DEFAULT generate_tracking_code() UNIQUE,
  campaign_name TEXT,
...
CREATE TABLE public.affiliate_conversions (
  ...
  conversion_type TEXT NOT NULL DEFAULT 'signup' CHECK (conversion_type IN ('signup', 'purchase', 'subscription')),
...
CREATE POLICY "Users can create affiliate applications" ON public.affiliates
...
CREATE POLICY "Affiliates can update their own links" ON public.affiliate_links
...
-- Create RLS policies for affiliate_conversions table
